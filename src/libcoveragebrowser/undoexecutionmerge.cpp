...
UndoCmdExecutionMerge::UndoCmdExecutionMerge (CSMes *csmes_p,const ExecutionNames &sources,const ExecutionName &name,QUndoCommand *parent) : QUndoCommand("",parent)
{
  m_csmes_p=csmes_p;
  m_name=name;
  m_sources=sources;
