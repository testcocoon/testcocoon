...
#ifndef EXPRESSION_AND_EXPR_H
#define EXPRESSION_AND_EXPR_H
...
class StringPool;
class Source;
class ExpressionAndExpr: public ExpressionNOP
{
public:
    ...
    virtual ~ExpressionAndExpr();

#if LOG
    virtual void PDEBUG() const ;
#endif
private:
    void operator=(const ExpressionAndExpr &);
    ExpressionAndExpr(const ExpressionAndExpr &);
};
