...
std::string FilterSource::appendDefault(bool ignore_flag,type_t type,const char *expression)
{
  FUNCTION_TRACE;
  return Filter::appendDefault(ignore_flag,static_cast<Filter::type_t>(type),expression);
}

std::string FilterSource::append(bool ignore_flag,type_t type,const char *expression)
{
  FUNCTION_TRACE;
