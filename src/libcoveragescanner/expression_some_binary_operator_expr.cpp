...
ExpressionSomeBinaryOperatorExpr::~ExpressionSomeBinaryOperatorExpr()
{
  FUNCTION_TRACE;
}

#if LOG
void ExpressionSomeBinaryOperatorExpr::PDEBUG() const
{
  FUNCTION_TRACE;
  DEBUG1("ExpressionSomeBinaryOperatorExpr");
  Expression::PDEBUG();
}
#endif
