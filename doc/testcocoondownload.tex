...
\TestCocoonLinuxSetup{1}{6}{14}
\TestCocoonWindowsSetup{1}{6}{14}
\TestCocoonMacosSetup{1}{6}{14}
...
\item[\CoverageScanner]
  \begin{itemize}
    ...
    \item \BugFix GNU \verb$__extension__$ keyword supported.
    ...
    \item \NewFeature new CoverageScanner API functions: \verb$__coveragescanner_register_library$ and \verb$__coveragescanner_unregister_library$.
